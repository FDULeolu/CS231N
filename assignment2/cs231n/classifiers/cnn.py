...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params['W1'] = np.random.randn(num_filters, self.C, filter_size, filter_size) * weight_scale
        self.params['W2'] = np.random.randn(num_filters * self.H * self.W, hidden_dim) * weight_scale
